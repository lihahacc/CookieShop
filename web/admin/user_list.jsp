	...
	<tr>
		...
		<c:forEach items="${p.list }" var="u">
			<tr>
				...
				<td><p>${u.address }</p></td>
				<td>
					<a class="btn btn-info" href="/CookieShop/admin/user_reset.jsp?id=${u.id }&username=${u.username }&email=${u.email }">重置密码</a>
					<a class="btn btn-primary" href="/CookieShop/admin/user_editshow?id=${u.id }">修改</a>
