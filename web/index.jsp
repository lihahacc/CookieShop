...
<div class="banner">
    <div class="container">
        <h2 class="hdng"><a href="/CookieShop/goods_detail?id=${scroll.id}">${scroll.name}</a><span></span></h2>
        <p>今日精选推荐</p>
